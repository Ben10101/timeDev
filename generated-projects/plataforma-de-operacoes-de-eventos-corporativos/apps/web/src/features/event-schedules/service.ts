import type { EventScheduleListResponse, EventScheduleRequest, EventScheduleResponse } from '../../../../../packages/shared/src/contracts/event-schedules.ts';
export const eventScheduleQueryKey = ['event-schedules'];
