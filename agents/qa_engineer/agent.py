...
class QAEngineer:
    ...
    def generate_test_scenarios(self, idea, code_structure):
        """
        Gera cenários de teste e plano de QA
        
        Args:
            idea: Descrição da ideia
            code_structure: Estrutura de código
            
        Returns:
            String com os testes formatados
        """
...
"""
    ...
    def process(self, idea, code_structure):
        """Processa estrutura de código e retorna testes"""
        return self.generate_test_scenarios(idea, code_structure)
