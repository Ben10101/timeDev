...
class Developer:
    ...
    def generate_code_structure(self, idea, architecture):
        """
        Gera a estrutura inicial do projeto e código base
        ...
        Returns:
            String com a estrutura de código
        """
...
"""
    ...
    def process(self, idea, architecture):
        """Processa arquitetura e retorna structure de código"""
        return self.generate_code_structure(idea, architecture)
