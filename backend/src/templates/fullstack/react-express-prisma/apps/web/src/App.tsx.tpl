  ...
  return (
    ...
    >
      <div style={{ display: 'grid', gap: 14, maxWidth: 760 }}>
        ...
        <h1 style={{ margin: 0, fontSize: 48, lineHeight: 1, letterSpacing: '-0.04em' }}>__PROJECT_NAME__</h1>
      ...
      <div style={{ display: 'grid', gap: 16, gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
        {productAreas.map((route) => (
          ...
          >
            ...
            <span style={{ display: 'block', marginTop: 10, color: 'rgba(248,250,252,0.7)' }}>
              Abrir modulo
            </span>
          </a>
        ))}
      ...
      <div style={{ maxWidth: 1220, margin: '0 auto', display: 'grid', gap: 24 }}>
        ...
        >
          <div style={{ display: 'grid', gap: 4 }}>
            ...
            <strong style={{ fontSize: 22 }}>__PROJECT_NAME__</strong>
          </div>
